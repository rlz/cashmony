...
export class Google {
    ...
    loadOperations = async (engine: Engine): Promise<Operation[]> => await loadOperations(this, engine)
    storeOperations = async (ops: readonly Operation[], engine: Engine): Promise<void> => { await storeOperations(this, ops, engine) }
    loadAccounts = async (engine: Engine): Promise<Account[]> => await loadAccounts(this, engine)
    storeAccounts = async (accounts: readonly Account[]): Promise<void> => { await storeAccounts(this, accounts) }
    loadCategories = async (engine: Engine): Promise<Category[]> => await loadCategories(this, engine)
    storeCategories = async (categories: readonly Category[]): Promise<void> => { await storeCategories(this, categories) }
    loadGoals = async (engine: Engine): Promise<Watch[]> => await loadGoals(this, engine)
    storeGoals = async (goals: readonly Watch[], engine: Engine): Promise<void> => { await storeGoals(this, goals, engine) }
}
