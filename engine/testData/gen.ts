...
//     for (let date = from; date <= to; date = date.plus({ day: 1 })) {
//         if (date.day === 3) {
//             operations.push({
//                 id: uuidv7(),
//                 type: 'expense',
...
//                 amount: 1000,
//                 account: {
//                     id: accounts['Yellow Bank USD'].id,
//                     amount: 1000
//                 },
//                 categories: [{
//                     id: categories['Rent/Mortgage'].id,
//                     amount: 1000
//                 }],
//                 tags: ['rent'],
//                 comment: null
...
//         }
//         if (date.day === 10) {
//             const electricityAmount = Math.random() * 40 + 80
//             const waterAmount = Math.random() * 10 + 30
